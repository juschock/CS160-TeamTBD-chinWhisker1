...
def create_process(_brand, _model, _type, _qty, _shave_image):
    shaver = Shaver(brand=_brand, model=_model, type=_type, qty=_qty, shave_image=_shave_image )
...
def edit_process(_id, _brand, _model, _type, _qty, _shave_image):
    Shaver.objects.filter(id=_id).update(brand=_brand, model=_model, type=_type, qty=_qty, shave_image=_shave_image )
